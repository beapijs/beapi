...
/**
 * BeAPI started sneaking event. Contains the logic
 * for translating Minecraft event data to BeAPI
 * wrapped data.
 */
export class StartedSneaking extends AbstractEvent {
  ...
  // Predefined in AbstractEvent.
  @setProto('StartedSneaking')
  public readonly name = 'StartedSneaking'
