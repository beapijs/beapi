...
// Type imports.
import type { Client, EntityHurtEvent } from '..'
 ...
 * wrapped data.
 */
export class EntityKilled extends AbstractEvent {
  ...
  // Predefined in AbstractEvent.
  @setProto('EntityKilled')
  public readonly name = 'EntityKilled'
  ...
  public on(): void {
    ...
    if (!this._registered) {
      ...
      this._client.addListener('EntityHurt', this._logic)
  ...
  public off(): void {
    ...
    if (this._registered) {
      ...
      this._client.removeListener('EntityHurt', this._logic)
